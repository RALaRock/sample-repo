...
# show the number of guests invided to dinner
print()
guestcount = len(guests)
print(f"We settled on inviting {guestcount} guests to join us for dinner.")
print(f"We settled on inviting {len(guests)} guests to join us for dinner.")
